...
RSpec.describe 'Items', type: :request do
  ...
  describe 'GET /v1/todos/:todo_id/items' do
    before { get "/v1/todos/#{todo_id}/items", params: {}, headers: headers }
  ...
  describe 'GET /v1/todos/:todo_id/items/:id' do
    before { get "/v1/todos/#{todo_id}/items/#{id}", params: {}, headers: headers }
  ...
  describe 'POST /v1/todos/:todo_id/items' do
    ...
    context 'when request attributes are valid' do
      before do
        post "/v1/todos/#{todo_id}/items", params: valid_attributes,
                                           headers: headers
      end
  ...
  describe 'PUT /v1/todos/:todo_id/items/:id' do
    ...
    before do
      put "/v1/todos/#{todo_id}/items/#{id}", params: valid_attributes,
                                              headers: headers
    end
  ...
  describe 'DELETE /v1/todos/:id' do
    before { delete "/v1/todos/#{todo_id}/items/#{id}", params: {}, headers: headers }
